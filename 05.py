...
#     else:
#         root_path = 'F:/ccrenew/' + "0359png9" + "/" + "png%d" % (a_diedai +a_diedai- 3) + "/"
#     dir = root_path
#     count = 0
...
cv_show('opi', img_c)
    #         cv2.imwrite('F:/ccrenew/' + "0359png9" + "/" + "png%d" % (a_diedai*2-1) + "/" + str(file), bw2)
    #         cv2.imwrite('F:/ccrenew/' + "0359png9" + "/" + "png%d" % (a_diedai*2) + "/" + str(file), img_c)
    #         count += 1
    #         # if count % 400 == 0:
    #         print(count)
    # a_diedai += 1
